    ...
    <>
      ...
      <main className="main-content">
        ...
        <div className="button-group fade-in">
          ...
          <Link href="/captions" className="primary-button">
            AI Captions Studio
            <svg className="arrow-icon" viewBox="0 0 24 24">
              <path d="M7 8h10M7 12h4M7 16h10M3 3h18v18H3z" stroke="currentColor" strokeWidth="2" fill="none"/>
            </svg>
          </Link>
